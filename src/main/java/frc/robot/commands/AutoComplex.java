 ...
 */
public class AutoComplex extends SequentialCommandGroup {
  /**
   ...
   */
  public AutoComplex(DriveSubsystem drive, IntakeSubsystem intake, ShooterSubsystem shooter)  //after drive, include other subsystems
   {
    addCommands(
